<div class="se-pre-con" style="display: none;"></div>
    ...
    <div class="header-type-4">
      <div id="shopify-section-header" class="shopify-section">
            ...
            <div class="container">
              <div class="grid__item menubar_inner">
                  ...
                  <h1 class="site-header__logo" itemscope="" itemtype="http://schema.org/Organization">
                    ...
                    <a href="/" style="max-width: px;">
                      <img class="normal-logo"
                        src="//cdn.shopify.com/s/files/1/0048/7040/6230/t/2/assets/logo.png?v=9068690341536339681"
                        alt="pr-kidswear" itemprop="logo">
                    </a>
                ...
                <ul class="menu_bar_right grid__item wide--one-third  post-large--one-third large--one-third">
                  ...
                  <li class="wide--hide post-large--hide large--hide">
                    <div class="header-search">
                      ...
                      <div class="slidersearch header_slide_element">
                        <form action="/search" method="get" class="search-bar__table-cell search-bar__form"
                          role="search">
                          <input type="text" id="search" name="q" value="" placeholder="Search..."
                            aria-label="Search..." class="search-bar__input sb-search-input">
                          <button class="sb-search-submit wide--hide post-large--hide large--hide res_btn" type="submit"
                            value=""><i class="icon-magnifier icons"></i></button>
                        </form>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="wishlist">
                    <a href="/pages/wishlist.php" title="Wishlist"><i class="icon-heart"></i></a>
                  </li>
                  ...
                  <li class="customer_account">
                    <div class="header-account_links">
                      <ul>
                        ...
                        <li>
                          <a href="/account/login.php" title="Log in" data-value="value 1"><i
                      ...
                      <div class="wrapper-top-cart">
                        ...
                        <div id="slidedown-cart" style="display:none">
                          ...
                          <div class="has-items" style="display: none;">
                            ...
                            <div class="actions">
                              <button class="btn" onclick="window.location='/checkout'"><i class="icon-check"></i>Check
                                Out</button>
                              <button class="btn text-cart" onclick="window.location='/products/cart.php'"><i
                                  class="icon-basket"></i>View Cart</button>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <style>
          .header-type-4 .site-nav-dropdown .container,
          .header-type-4 .desktop-megamenu .site-nav-dropdown {
            border: 2px dashed #e64974;
          }
          ...
          .header-type-4 .customer_account ul li a,
          .header-type-4 .wishlist a,
          .header-type-4 .header-mobile {
            color: #191717;
          }

          .header-type-4 .site-header__logo a:hover,
          .header-type-4 .customer_account ul li a:hover,
          .header-type-4 .wishlist a:hover {
            color: #ffb51c;
          }
          ...
          .header-type-4 .header_currency ul li.currency .selector-arrow:after {
            color: #ffffff;
          }

          .header-type-4 .header_currency ul select:hover,
          .header_currency ul li.currency .selector-arrow:hover::after {
            color: #ffb51c;
          }

          .header-type-4 .header_currency ul li.currency:hover:after {
            border-top-color: #ffb51c;
          }
          ...
          .header-type-4 .dt-sc-toggle-content {
            background: #000;
          }

          .header-type-4 .inline-list li a {
            color: #191717;
          }

          .header-type-4 .inline-list li a:hover {
            color: #191717;
          }

          .header-type-4 .init.dt-sc-toggle:hover {
            color: #191717;
          }
          ...
          .site-nav-dropdown p.toogleClick {
            background: url(//cdn.shopify.com/s/files/1/0048/7040/6230/t/2/assets/icon-megamenu.png?268) no-repeat;
            padding: 0;
            width: 8px;
            height: 8px;
            right: 0;
                        ...
                        <ul class="site-nav">
                          <li class="  dropdown">
                            ...
                            <ul class="site-nav-dropdown">
                              <li>
                                <a href="/collections/boys-tops-t-shirt.php" class="">
                                  <span>
                                    Tops &amp; T-shirts
                                  </span>
                                </a>
                              ...
                              <li>
                                <a href="/collections/boys-bottoms.php" class="">
                                  <span>
                                    Bottoms
                                  </span>
                              ...
                              <li>
                                <a href="/collections/boys-outerwear-coats.php" class="">
                                  <span>
                                    Outerwear &amp; Coats
                                  </span>
                              ...
                              <li>
                                <a href="/collections/boys-shoes.php" class="">
                                  <span>
                                    Boys Shoes
                                  </span>
                          ...
                          <li class="  dropdown">
                            ...
                            <ul class="site-nav-dropdown">
                              ...
                              <li>
                                <a href="/collections/girls-tops-t-shirt.php" class="">
                                  <span>
                                    Tops &amp; T-shirts
                                  </span>
                              ...
                              <li>
                                <a href="/collections/girls-pajamas.php" class="">
                                  <span>
                                    Pajamas
                                  </span>
                              ...
                              <li>
                                <a href="/collections/swimwear.php" class="">
                                  <span>
                                    Swimwear
                                  </span>
                              ...
                              <li>
                                <a href="/collections/girls-bottoms.php" class="">
                                  <span>
                                    Bottoms
                                  </span>
                              ...
                              <li>
                                <a href="/collections/girls-outerwear-coats.php" class="">
                                  <span>
                                    Outerwear &amp; Coats
                                  </span>
                              ...
                              <li>
                                <a href="/collections/girls-shoes.php" class="">
                                  <span>
                                    Girls Shoes
                                  </span>
                          ...
                          <li class="  dropdown">
                            ...
                            <ul class="site-nav-dropdown">
                              ...
                              <li>
                                <a href="/collections/baby-clothing.php" class="">
                                  <span>
                                    Baby Clothing
                                  </span>
                              ...
                              <li>
                                <a href="/collections/baby-shoes.php" class="">
                                  <span>
                                    Baby Shoes
                                  </span>
                              ...
                              <li>
                                <a href="/collections/baby-accessories.php" class="">
                                  <span>
                                    Baby Accessories
                                  </span>
                              ...
                              <li>
                                <a href="/collections/baby-apparel.php" class="">
                                  <span>
                                    Baby Apparel
                                  </span>
                          ...
                          <li class="  dropdown">
                            ...
                            <ul class="site-nav-dropdown">
                              ...
                              <li>
                                <a href="/collections/hats.php" class="">
                                  <span>
                                    Hats
                                  </span>
                              ...
                              <li>
                                <a href="/collections/sunglasses.php" class="">
                                  <span>
                                    Sunglasses
                                  </span>
                              ...
                              <li>
                                <a href="/collections/watches.php" class="">
                                  <span>
                                    Watches
                                  </span>
                              ...
                              <li>
                                <a href="/collections/kids-bags.php" class="">
                                  <span>
                                    Kids Bags
                                  </span>
                          ...
                          <li class=" ">
                            <a href="/collections/toys.php" class="">
                              <span>
                                Toys And Games
                              </span>
                            </a>
